{
  inputs = {
    ...
    blenderMacOSAarch64 = {
      url = "https://mirror.clarkson.edu/blender/release/Blender3.6/blender-3.6.5-macos-arm64.dmg";
      flake = false;
    };
    blenderMacOSx86_64 = {
      url = "https://mirror.clarkson.edu/blender/release/Blender3.6/blender-3.6.5-macos-x64.dmg";
      flake = false;
    };
    dozer = {
