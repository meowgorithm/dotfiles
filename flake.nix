{
  ...
  inputs.blenderMacOSAarch64.url = "https://mirror.clarkson.edu/blender/release/Blender4.3/blender-4.3.2-macos-arm64.dmg";
  inputs.blenderMacOSAarch64.flake = false;
  inputs.blenderMacOSx86_64.url = "https://mirror.clarkson.edu/blender/release/Blender4.3/blender-4.3.2-macos-x64.dmg";
