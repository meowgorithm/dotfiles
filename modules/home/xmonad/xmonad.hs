...
import XMonad (
    ...
    WindowSet,
    X,
    XConfig (XConfig, borderWidth, focusedBorderColor, keys, manageHook, modMask, normalBorderColor, terminal, workspaces),
    appName,
    className,
    composeAll,
    controlMask,
...
import XMonad.Hooks.DynamicLog (PP, ppCurrent, ppHidden, ppOrder, ppSep, ppTitle, statusBar, xmobar, xmobarColor, xmobarPP)
...
import XMonad.Layout.Spacing (Border (Border), smartSpacing, spacingRaw, toggleScreenSpacingEnabled, toggleWindowSpacingEnabled)
